...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, OnSnapPositionChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ShopListAdapter shopListAdapter = new ShopListAdapter(getList());
    ...
    public void onSnapPositionChange(int position) {
        ...
        final Marker currentMarker = googleMap.addMarker(new MarkerOptions().position(coordinate).title(currentItem.getShopName()).icon(BitmapDescriptorFactory.fromBitmap(createBitmap(currentItem.getShopName(), currentItem.getRating()))));
    ...
    private ArrayList<ShopListItem> getList() {
